        ...
        <main className="min-h-screen flex flex-col items-center justify-center p-4 md:p-24 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-900 via-[#0a0514] to-black text-white">
            <div className="z-10 w-full max-w-6xl flex flex-col items-center text-center">
                <h1 className="text-5xl md:text-8xl font-black tracking-tighter mb-4 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    AMIR<span className="text-violet-500 font-light italic">SUB</span>
                </h1>
                ...
                <div className="flex p-1 bg-white/5 rounded-full mb-8 border border-white/10">
                    <button
                        ...
                        className={`flex items-center gap-2 px-6 py-2 rounded-full font-bold transition-all ${activeTab === 'front' ? 'bg-violet-600 text-white shadow-lg shadow-violet-500/25' : 'text-gray-400 hover:text-white'}`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-6 py-2 rounded-full font-bold transition-all ${activeTab === 'side' ? 'bg-violet-600 text-white shadow-lg shadow-violet-500/25' : 'text-gray-400 hover:text-white'}`}
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start w-full">
                    ...
                    <div className="flex flex-col items-center space-y-6">
                        <div className="relative group w-full aspect-square max-w-sm rounded-[2rem] overflow-hidden border-2 border-dashed border-white/20 bg-white/5 hover:border-violet-500/50 transition-all duration-500 flex items-center justify-center">
                            {currentImage ? (
                                ...
                                <div className="w-full h-full flex flex-col items-center justify-center gap-4">
                                    ...
                                    >
                                        <Upload className="w-12 h-12 text-gray-500 mb-4 group-hover/btn:text-violet-500 transition-colors" />
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-2 text-gray-400 hover:text-violet-400 transition-colors text-sm font-bold uppercase tracking-wider"
                                    >
                        ...
                        <div className="flex gap-4 w-full max-w-sm">
                            ...
                            <button
                                ...
                                className={`flex-[2] py-4 rounded-2xl font-black tracking-widest transition-all shadow-lg shadow-violet-500/20 ${!currentImage || loading
                                    ? 'bg-gray-800 text-gray-500 cursor-not-allowed'
                                    : 'bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:scale-[1.02] active:scale-[0.98]'
                                    }`}
                            >
                                {loading ? (
                    ...
                    <div className="flex flex-col items-center lg:items-start justify-center min-h-[400px]">
                        {currentResult ? (
                            ...
                            <div className="text-center lg:text-left space-y-4 opacity-40">
                                <div className="w-16 h-1 bg-violet-500 rounded-full mx-auto lg:mx-0"></div>
